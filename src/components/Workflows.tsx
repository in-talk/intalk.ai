...
export default function Workflows() {
  return (
    <section>
      <div id="features" className="mx-auto max-w-6xl px-4 sm:px-6 relative z-40 md:-top-[200px]">
        <div className="pb-12 md:pb-20">
          ...
          {/* Spotlight items */}
          <Spotlight className="group mx-auto grid max-w-sm items-start gap-6 lg:max-w-none lg:grid-cols-3 mt-[100px]">
            {/* Card 1 */}
            <a
