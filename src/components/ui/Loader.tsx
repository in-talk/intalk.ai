...
const Loader = ({ onComplete}:any) => {
 ...
 function handleClick(){
  ...
  return (
    <div
      data-cursor="-custom"
      className={` ${clicked ? 'loading-screen':''} absolute !z-[999999999] flex h-screen w-full flex-col items-center justify-center overflow-hidden  md:shadow-xl  bg-gray-950`}
    >
